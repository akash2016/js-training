...
Functions that operates on other functions, either by taking them as arguments or by returning them, are called higher-order functions.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkyNzAwMTQwNywyMDkyMjkxMTY5LC03NT
IxMDU4NThdfQ==
-->